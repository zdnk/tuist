...
final class TargetTests: XCTestCase {
    func test_toJSON() {
        ...
        """
        {
          ...
          "bundle_id": "bundle_id",
          "core_data_models": [{ "path": "pat", "current_version": "version" }],
          "actions": [
            { "arguments": ["arg"], "path": "path", "order": "post", "name": "name" }
          ],
          "product": "app",
          ...
          "dependencies": [
            ...
            { "type": "project", "target": "target", "path": "path" },
